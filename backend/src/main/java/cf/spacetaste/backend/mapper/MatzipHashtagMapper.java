...
public interface MatzipHashtagMapper {
    ...
    @Insert("INSERT INTO matzip_hashtag (matzip_id, hashtag_id) VALUES (#{matzip.matzipId}, #{hashtag.hashtagId}) ON DUPLICATE KEY UPDATE matzip_id=matzip_id")
    ...
    @Select("SELECT b.content FROM matzip_hashtag AS a NATURAL JOIN hashtag AS b WHERE a.matzip_id=${matzipId}")
